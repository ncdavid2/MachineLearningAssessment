...
def correlation_analysis():
    ...
    expense_columns = ['Monthly Income (£)', 'Water Bill (£)', 'Electricity Bill (£)', 'Gas Bill (£)', 'Groceries (£)', 'Transportation (£)',
                       'Sky Sports (£)', 'Other Expenses (£)', 'Savings for Property (£)', 'Monthly Outing (£)', 'Netflix (£)', 'Amazon Prime (£)']
